...
@section('title', __('messages.complaint_service') . __('messages.site_title_suffix'))

@section('content')
<div class="page-hero">
    <div class="container">
        <h2><i class="fas fa-comments me-2"></i>{{ __('messages.complaint_service') }}</h2>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ __('messages.complaint_service') }}</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="container my-5">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body text-center py-5">
            ...
            <p class="text-muted">{{ __('messages.empty_pengaduan') }}</p>
