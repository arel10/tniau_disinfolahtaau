...
@section('title', __('messages.public_service_news') . __('messages.site_title_suffix'))

@section('content')
<div class="page-hero">
    <div class="container">
        <h2><i class="fas fa-newspaper me-2"></i>{{ __('messages.public_service_news') }}</h2>
...
<div class="container my-5">
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body p-4">
                ...
                <div class="ratio ratio-16x9 mb-3" style="max-width:100%; margin:0 auto;">
                    <iframe src="{{ $item->youtube_embed_url }}" allowfullscreen
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body text-center py-5">
            ...
            <p class="text-muted">{{ __('messages.empty_berita_pelayanan') }}</p>
