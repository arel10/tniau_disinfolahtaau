...
@section('title', __('messages.pemantauan') . ' - ' . __('messages.zona_integritas'))

@section('hero')
<div class="page-hero">
    <div class="container-fluid px-3">
        <h2><i class="fas fa-chart-line me-2"></i>{{ __('messages.hero_pemantauan') }}</h2>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ __('messages.pemantauan') }}</li>
            </ol>
        </nav>
    </div>
</div>
...
<style>
/* ================================================================
   ZI PAGE - Modern Layout (Pemantauan)
================================================================ */
.zi-page-section {
    padding: 50px 0 70px;
    background: #f4f6f9;
...
<section class="zi-page-section">
    <div class="container">
        ...
        <div class="zi-empty">
            ...
            <p>{{ __('messages.empty_pemantauan') }}</p>
        </div>
        @endforelse
    </div>
</section>
