...
@section('title', 'Tambah Kategori Penetapan')
@section('page-title', 'Tambah Kategori Penetapan')
        ...
        <div class="col-xl-6 col-lg-8">
            <div class="d-flex align-items-center mb-4 gap-3">
                ...
                <div class="flex-grow-1">
                    <h4 class="mb-0 fw-bold text-dark">Tambah Kategori</h4>
                    <small class="text-muted">Tambah kategori penetapan baru.</small>
                </div>
            ...
            <div class="card setting-card">
                <div class="card-header">
                    <h6 class="mb-0 fw-bold"><i class="fas fa-folder-plus me-2"></i>Data Kategori</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.zi.penetapan.kategori.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
