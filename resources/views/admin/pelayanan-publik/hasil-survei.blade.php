...
@section('page-title', __('messages.admin_hasil_survei'))
        ...
        <div class="col-xl-10 col-lg-12">
            ...
            <div class="d-flex align-items-center mb-4 gap-3">
                ...
                <div class="flex-grow-1">
                    <h4 class="mb-0 fw-bold text-dark">Hasil Survey Kepuasan</h4>
                    <small class="text-muted">Kelola hasil survey kepuasan — semua field bersifat opsional, minimal satu harus diisi.</small>
                </div>
            </div>
            ...
            <div class="card setting-card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if(isset($item))
                    <a href="{{ route('admin.pelayanan-publik.hasil-survei.index') }}" class="btn btn-sm btn-outline-light">
                        <i class="fas fa-times me-1"></i>Batal Edit
                    </a>
                    @endif
                </div>
                <div class="card-body p-4">
                    <form action="{{ isset($item) ? route('admin.pelayanan-publik.hasil-survei.update', $item->id) : route('admin.pelayanan-publik.hasil-survei.store') }}"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="judul" class="form-control"
                                       ...
                                       placeholder="Judul hasil survey (opsional)">
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <small class="text-muted">Upload gambar atau video (boleh banyak, tanpa batas jumlah dan ukuran).</small>
                            ...
                            <div class="col-12">
                                ...
                                <small class="text-muted">Upload file PDF (boleh banyak, tanpa batas jumlah dan ukuran).</small>
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="text-muted"><i class="fas fa-info-circle me-1"></i>Masukkan URL tujuan — pengunjung akan diarahkan ke link ini saat mengklik logo di atas.</small>
                            </div>
            ...
            <div class="card setting-card">
                <div class="card-header">
                    <h6 class="mb-0 fw-bold"><i class="fas fa-list me-2"></i>Daftar Hasil Survey Kepuasan ({{ $items->count() }})</h6>
                </div>
                <div class="card-body p-0">
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.pelayanan-publik.hasil-survei.toggle-publish', $row->id) }}" method="POST" class="d-inline">
                                            @csrf
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.pelayanan-publik.hasil-survei.edit', $row->id) }}" class="btn btn-sm btn-outline-primary me-1"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('admin.pelayanan-publik.hasil-survei.destroy', $row->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus data ini?')">
                                            @csrf @method('DELETE')
                    ...
                    <div class="py-5 text-center">
                        ...
                        <p class="text-muted mb-0">Belum ada data Hasil Survey Kepuasan.</p>
                    </div>
                    @endif
                </div>
            </div>
