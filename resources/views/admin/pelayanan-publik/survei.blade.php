...
@section('page-title', __('messages.admin_survei_kepuasan'))
        ...
        <div class="col-xl-10 col-lg-12">
            ...
            <div class="d-flex align-items-center mb-4 gap-3">
                ...
                <div class="flex-grow-1">
                    <h4 class="mb-0 fw-bold text-dark">Survei Kepuasan Publik</h4>
                    <small class="text-muted">Kelola survei kepuasan publik — semua field bersifat opsional, minimal satu harus diisi.</small>
                </div>
            </div>
            ...
            <div class="card setting-card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if(isset($item))
                    <a href="{{ route('admin.pelayanan-publik.survei.index') }}" class="btn btn-sm btn-outline-light">
                        <i class="fas fa-times me-1"></i>Batal Edit
                    </a>
                    @endif
                </div>
                <div class="card-body p-4">
                    <form action="{{ isset($item) ? route('admin.pelayanan-publik.survei.update', $item->id) : route('admin.pelayanan-publik.survei.store') }}"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="judul" class="form-control"
                                       ...
                                       placeholder="Judul survei (opsional)">
                            </div>
            ...
            <div class="card setting-card">
                <div class="card-header">
                    <h6 class="mb-0 fw-bold"><i class="fas fa-list me-2"></i>Daftar Survei Kepuasan Publik ({{ $items->count() }})</h6>
                </div>
                <div class="card-body p-0">
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.pelayanan-publik.survei.toggle-publish', $row->id) }}" method="POST" class="d-inline">
                                            @csrf
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.pelayanan-publik.survei.edit', $row->id) }}" class="btn btn-sm btn-outline-primary me-1"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('admin.pelayanan-publik.survei.destroy', $row->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus data ini?')">
                                            @csrf @method('DELETE')
                    ...
                    <div class="py-5 text-center">
                        ...
                        <p class="text-muted mb-0">Belum ada data Survei Kepuasan Publik.</p>
                    </div>
                    @endif
                </div>
            </div>
