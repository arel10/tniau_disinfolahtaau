...
@section('title', 'Edit Halaman ZI')
@section('page-title', 'Edit Halaman - ' . ucwords(str_replace('_', ' ', $type)))
        ...
        <div class="col-xl-7 col-lg-9">
            <div class="d-flex align-items-center mb-4 gap-3">
                ...
                <div class="flex-grow-1">
                    <h4 class="mb-0 fw-bold text-dark">Edit Halaman ZI</h4>
                    <small class="text-muted">Ubah data halaman Zona Integritas.</small>
                </div>
            ...
            <div class="card setting-card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.zi.pages.update', ['type' => $type, 'ziPage' => $ziPage->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf @method('PUT')
                        @include('admin.zi-pages._form', ['ziPage' => $ziPage])
