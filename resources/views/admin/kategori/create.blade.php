...
@section('title', __('messages.title_tambah', ['item' => __('messages.kategori')]))
@section('page-title', __('messages.title_tambah', ['item' => __('messages.kategori')]))
        ...
        <div class="col-xl-7 col-lg-9">
            <div class="d-flex align-items-center mb-4 gap-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <small class="text-muted">Tambah kategori berita baru.</small>
                </div>
