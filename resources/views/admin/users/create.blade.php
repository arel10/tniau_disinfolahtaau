...
@section('title', __('messages.admin_tambah_user'))
@section('page-title', __('messages.admin_tambah_user'))
        ...
        <div class="col-xl-8 col-lg-10">
            <div class="d-flex align-items-center mb-4 gap-3">
                ...
                <div class="flex-grow-1">
                    <h4 class="mb-0 fw-bold text-dark">Tambah User</h4>
            ...
            <div class="card setting-card">
                <div class="card-header">
                    <h6 class="mb-0 fw-bold"><i class="fas fa-user-plus me-2"></i>Data User</h6>
                </div>
                <div class="card-body">
