...
@section('title', 'Pemantauan ZI')
@section('page-title', __('messages.admin_pemantauan'))
        ...
        <div class="col-xl-10 col-lg-12">
            ...
            <div class="d-flex align-items-center mb-4 gap-3">
                ...
                <div class="flex-grow-1">
                    <h4 class="mb-0 fw-bold text-dark">Pemantauan ZI</h4>
                    <small class="text-muted">Kelola item pemantauan Zona Integritas.</small>
                </div>
                <a href="{{ route('admin.zi.pemantauan.create') }}" class="btn btn-tambah">
            ...
            <div class="card setting-card">
                <div class="card-header">
                    <h6 class="mb-0 fw-bold"><i class="fas fa-list me-2"></i>Daftar Item Pemantauan</h6>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-1 justify-content-center">
                                            <a href="{{ route('admin.zi.pemantauan.edit', $item->id) }}" class="btn btn-sm btn-outline-warning" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('admin.zi.pemantauan.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus item ini?')">
                                                @csrf @method('DELETE')
